...
#   c) node1 mines 32 blocks, so now node 0 has 500000POPC, node 1 has 4250POPC, node2 has none.
#   d) node0 sends 601 POPC to node2, in two transactions (301 POPC, then 300 POPC).
