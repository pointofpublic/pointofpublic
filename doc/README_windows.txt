...
Intro
-----
PointOfPublicCoin (POPC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. PointOfPublicCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run pointofpubliccoin-qt.exe.

PointOfPublicCoin Core is the original PointOfPublicCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of PointOfPublicCoin transactions;
