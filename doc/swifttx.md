...
This mechanism has been integrated into Bitcore-Node-PointOfPublicCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PointOfPublicCoin/insight-api-pointofpubliccoin#web-socket-api](https://github.com/PointOfPublicCoin/insight-api-pointofpubliccoin#web-socket-api)
* API: [https://github.com/PointOfPublicCoin/insight-api-pointofpubliccoin#swifttx-transactions](https://github.com/PointOfPublicCoin/insight-api-pointofpubliccoin#swifttx-transactions)
...
By default, the PointOfPublicCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PointOfPublicCoin Core daemon:
