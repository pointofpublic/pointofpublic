...
In order to support loading of multiple wallets in pointofpubliccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pointofpubliccoin.cpp.
...
Changes to pointofpubliccoin.cpp
----------------------
pointofpubliccoin.cpp is the entry point into pointofpubliccoin-qt, and as such, will require some minor modifications to provide hooks for
