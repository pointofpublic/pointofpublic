Contributing to PointOfPublicCoin Core
==================================

The PointOfPublicCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PointOfPublicCoin Core project, and is not to be
confused with overall PointOfPublicCoin Network Protocol consensus changes.

Whether a pull request is merged into PointOfPublicCoin Core rests with the project merge
...
Patches that change PointOfPublicCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the PointOfPublicCoin consensus, it must have been
...
The project leader is the release manager for each PointOfPublicCoin Core release.
