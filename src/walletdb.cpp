...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("pointofpubliccoin-wallet");
...
bool CWalletDB::Recover(CDBEnv& dbenv, std::string filename, bool fOnlyKeys)
{
    ...
    // Call PointOfPublicCoin with fAggressive=true to
    // get as much data as possible.
    // Rewrite pointofpubliccoind data to wallet.dat
    ...
    std::vector<CDBEnv::KeyValPair> pointofpubliccoindData;
    bool allOK = dbenv.PointOfPublicCoin(newFilename, true, pointofpubliccoindData);
    if (pointofpubliccoindData.empty()) {
        LogPrintf("PointOfPublicCoin(aggressive) found no records in %s.\n", newFilename);
        return false;
    }
    LogPrintf("PointOfPublicCoin(aggressive) found %u records\n", pointofpubliccoindData.size());
    ...
    BOOST_FOREACH (CDBEnv::KeyValPair& row, pointofpubliccoindData) {
        if (fOnlyKeys) {
