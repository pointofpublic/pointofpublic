...
#if defined(NDEBUG)
#error "PointOfPublicCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in upopc) are considered zero fee (for relaying and mining)
...
{
    RenameThread("pointofpubliccoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // POPC: We use certain sporks during IBD, so check to see if they are
