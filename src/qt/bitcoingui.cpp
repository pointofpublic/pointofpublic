                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PointOfPublicCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a POPC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pointofpubliccoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PointOfPublicCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PointOfPublicCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PointOfPublicCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your POPC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified POPC addresses"));
    ...
    openAction->setStatusTip(tr("Open a pointofpubliccoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PointOfPublicCoin Core help message to get a list with possible PointOfPublicCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PointOfPublicCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PointOfPublicCoin network", "", count));
}
...
{
    QString strTitle = tr("PointOfPublicCoin Core"); // default title
    ...
    // Append title to "PointOfPublicCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
