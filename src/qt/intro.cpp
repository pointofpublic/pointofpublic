...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PointOfPublicCoin Core"),
     ...
     * override -datadir in the pointofpubliccoin.conf file in the default data directory
     * (to be consistent with pointofpubliccoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
