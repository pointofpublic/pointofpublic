...
/** Utility functions used by the PointOfPublicCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render POPC addresses in monospace font
...
// Parse "pointofpubliccoin:" URI into recipient object, return true on successful parsing
