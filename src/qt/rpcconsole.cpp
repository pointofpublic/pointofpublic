...
// Repair parameters
const QString POINTOFPUBLICCOINWALLET("-pointofpubliccoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_pointofpubliccoinwallet, SIGNAL(clicked()), this, SLOT(walletPointOfPublicCoin()));
...
/** Restart wallet with "-pointofpubliccoinwallet" */
void RPCConsole::walletPointOfPublicCoin()
{
    buildParameterlist(POINTOFPUBLICCOINWALLET);
}
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    args.removeAll(POINTOFPUBLICCOINWALLET);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PointOfPublicCoin RPC console.") + "<br>" +
