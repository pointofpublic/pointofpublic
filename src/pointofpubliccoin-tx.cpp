...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PointOfPublicCoin Core pointofpubliccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pointofpubliccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pointofpubliccoin transaction") + "\n" +
                               "  pointofpubliccoin-tx [options] -create [commands]   " + _("Create hex-encoded pointofpubliccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pointofpubliccoin transaction
