...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop PointOfPublicCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "PointOfPublicCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PointOfPublicCoin features */
        {"pointofpubliccoin", "masternode", &masternode, true, true, false},
        {"pointofpubliccoin", "listmasternodes", &listmasternodes, true, true, false},
        {"pointofpubliccoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pointofpubliccoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pointofpubliccoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pointofpubliccoin", "masternodedebug", &masternodedebug, true, true, false},
        {"pointofpubliccoin", "startmasternode", &startmasternode, true, true, false},
        {"pointofpubliccoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pointofpubliccoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pointofpubliccoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pointofpubliccoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pointofpubliccoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pointofpubliccoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pointofpubliccoin", "mnbudget", &mnbudget, true, true, false},
        {"pointofpubliccoin", "preparebudget", &preparebudget, true, true, false},
        {"pointofpubliccoin", "submitbudget", &submitbudget, true, true, false},
        {"pointofpubliccoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pointofpubliccoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pointofpubliccoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pointofpubliccoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pointofpubliccoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pointofpubliccoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pointofpubliccoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pointofpubliccoin", "checkbudgets", &checkbudgets, true, true, false},
        {"pointofpubliccoin", "mnsync", &mnsync, true, true, false},
        {"pointofpubliccoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> pointofpubliccoin-cli " + methodname + " " + args + "\n";
}
